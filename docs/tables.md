...
Generated at (UTC): 2026-04-23T05:08:05.466815+00:00
...
| __STATS | `["__STATS", 1, 250, null, "REJECT", "SYSTEM", "PUBLIC", 1002, 11]` |
...
| BuySells | `["BuySells", 0, 100, null, "REJECT", "USER", "PUBLIC", 9777, 22]` |
| BuySellsAgg | `["BuySellsAgg", 0, 100, null, "REJECT", "USER", "PUBLIC", 1969, 26]` |
| BuySellsAggC1 | `["BuySellsAggC1", 0, 100, null, "REJECT", "USER", "PUBLIC", 2021, 27]` |
| BuySellsAggC2 | `["BuySellsAggC2", 0, 100, null, "REJECT", "USER", "PUBLIC", 1969, 27]` |
| conrevNetBookDelta | `["conrevNetBookDelta", 1, 100, null, "REJECT", "USER", "PUBLIC", 52, 43]` |
...
| NetBook | `["NetBook", 1, 100, null, "REJECT", "USER", "PUBLIC", 1969, 37]` |
| NetBookC | `["NetBookC", 1, 100, null, "REJECT", "USER", "PUBLIC", 1969, 40]` |
| NetBookGrouped | `["NetBookGrouped", 0, 100, null, "REJECT", "USER", "PUBLIC", 103, 8]` |
| NetBookGroupedFiltered | `["NetBookGroupedFiltered", 0, 100, null, "REJECT", "USER", "PUBLIC", 101, 8]` |
| NetBookSnap | `["NetBookSnap", 1, 1000, null, "REJECT", "USER", "PUBLIC", 24720, 37]` |
| NetBookSnap2 | `["NetBookSnap2", 1, 1000, null, "REJECT", "USER", "PUBLIC", 0, 36]` |
| NetPnl | `["NetPnl", 1, 3000, null, "REJECT", "USER", "PUBLIC", 1, 2]` |
| nse_tbt_snap | `["nse_tbt_snap", 0, 100, null, "ADD", "USER", "PUBLIC", 1321, 39]` |
| order_msgs_noxml | `["order_msgs_noxml", 1, 100, null, "ADD", "USER", "PUBLIC", 9777, 30]` |
| order_msgs_noxml_clean | `["order_msgs_noxml_clean", 0, 100, null, "ADD", "USER", "PUBLIC", 9777, 30]` |
...
| TradeBook | `["TradeBook", 1, 100, null, "ADD", "USER", "PUBLIC", 9777, 44]` |
| TradeBook_TID | `["TradeBook_TID", 0, 100, null, "REJECT", "USER", "PUBLIC", 9777, 44]` |
| TradeSummary | `["TradeSummary", 1, 100, null, "REJECT", "USER", "PUBLIC", 103, 7]` |
