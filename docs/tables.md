...
| __STATS | `["__STATS", 1, 250, null, "REJECT", "SYSTEM", "PUBLIC", 1131, 11]` |
...
| BuySells | `["BuySells", 0, 100, null, "REJECT", "USER", "PUBLIC", 11369, 22]` |
| BuySellsAgg | `["BuySellsAgg", 0, 100, null, "REJECT", "USER", "PUBLIC", 2310, 26]` |
| BuySellsAggC1 | `["BuySellsAggC1", 0, 100, null, "REJECT", "USER", "PUBLIC", 2371, 27]` |
| BuySellsAggC2 | `["BuySellsAggC2", 0, 100, null, "REJECT", "USER", "PUBLIC", 2310, 27]` |
| conrevNetBookDelta | `["conrevNetBookDelta", 1, 100, null, "REJECT", "USER", "PUBLIC", 61, 43]` |
...
| NetBook | `["NetBook", 1, 100, null, "REJECT", "USER", "PUBLIC", 2310, 37]` |
| NetBookC | `["NetBookC", 1, 100, null, "REJECT", "USER", "PUBLIC", 2310, 40]` |
...
| NetBookSnap | `["NetBookSnap", 1, 1000, null, "REJECT", "USER", "PUBLIC", 38007, 37]` |
| NetBookSnap2 | `["NetBookSnap2", 1, 1000, null, "REJECT", "USER", "PUBLIC", 0, 36]` |
| NetPnl | `["NetPnl", 1, 3000, null, "REJECT", "USER", "PUBLIC", 1, 2]` |
| nse_tbt_snap | `["nse_tbt_snap", 0, 100, null, "ADD", "USER", "PUBLIC", 1520, 39]` |
| order_msgs_noxml | `["order_msgs_noxml", 1, 100, null, "ADD", "USER", "PUBLIC", 11369, 30]` |
| order_msgs_noxml_clean | `["order_msgs_noxml_clean", 0, 100, null, "ADD", "USER", "PUBLIC", 11369, 30]` |
...
| TradeBook | `["TradeBook", 1, 100, null, "ADD", "USER", "PUBLIC", 11369, 44]` |
| TradeBook_TID | `["TradeBook_TID", 0, 100, null, "REJECT", "USER", "PUBLIC", 11369, 44]` |
