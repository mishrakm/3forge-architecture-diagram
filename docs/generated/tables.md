...
| __STATS | `["__STATS", 1, 250, null, "REJECT", "SYSTEM", "PUBLIC", 1338, 11]` |
...
| BuySells | `["BuySells", 0, 100, null, "REJECT", "USER", "PUBLIC", 14413, 22]` |
| BuySellsAgg | `["BuySellsAgg", 0, 100, null, "REJECT", "USER", "PUBLIC", 2823, 26]` |
| BuySellsAggC1 | `["BuySellsAggC1", 0, 100, null, "REJECT", "USER", "PUBLIC", 2902, 27]` |
| BuySellsAggC2 | `["BuySellsAggC2", 0, 100, null, "REJECT", "USER", "PUBLIC", 2823, 27]` |
...
| NetBook | `["NetBook", 1, 100, null, "REJECT", "USER", "PUBLIC", 2823, 37]` |
| NetBookC | `["NetBookC", 1, 100, null, "REJECT", "USER", "PUBLIC", 2823, 40]` |
...
| NetBookSnap | `["NetBookSnap", 1, 1000, null, "REJECT", "USER", "PUBLIC", 59345, 37]` |
| NetBookSnap2 | `["NetBookSnap2", 1, 1000, null, "REJECT", "USER", "PUBLIC", 0, 36]` |
| NetPnl | `["NetPnl", 1, 3000, null, "REJECT", "USER", "PUBLIC", 1, 2]` |
| nse_tbt_snap | `["nse_tbt_snap", 0, 100, null, "ADD", "USER", "PUBLIC", 1746, 39]` |
| order_msgs_noxml | `["order_msgs_noxml", 1, 100, null, "ADD", "USER", "PUBLIC", 14413, 30]` |
| order_msgs_noxml_clean | `["order_msgs_noxml_clean", 0, 100, null, "ADD", "USER", "PUBLIC", 14413, 30]` |
...
| TradeBook | `["TradeBook", 1, 100, null, "ADD", "USER", "PUBLIC", 14413, 44]` |
| TradeBook_TID | `["TradeBook_TID", 0, 100, null, "REJECT", "USER", "PUBLIC", 14413, 44]` |
