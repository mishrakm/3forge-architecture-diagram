...
```
cd existing_repo
git remote add origin https://pwgit.centralindia.cloudapp.azure.com/3forge/3forge-architecture-diagram.git
...
- [ ] [Set up project integrations](https://pwgit.centralindia.cloudapp.azure.com/3forge/3forge-architecture-diagram/-/settings/integrations)
